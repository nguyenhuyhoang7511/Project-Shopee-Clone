                                ...
                                <div class="has-cart"> 
                                    ...
                                    <ul class="cart__list-products">                     
                                        <li class="cart___list-item">
                                            <img src="../assets/image/l-sp-4-1.jpg" alt="" class="cart__item-img-product">

                                            <div class="cart__item-info">
                                                <div class="cart__info-head">
                                                        <h5 class="cart__info-name">Áo thun nam nữ unisex tay lỡ Angel Devil, áo phông cotton freesize AD-Trend</h5>
