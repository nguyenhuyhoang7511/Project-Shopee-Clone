                                ...
                                <div class="has-cart"> 
                                    ...
                                    <ul class="cart__list-products">                     
                                        <li class="cart___list-item">
                                            <img src="../assets/image/l-sp-7-1.jpg" alt="" class="cart__item-img-product">

                                            <div class="cart__item-info">
                                                <div class="cart__info-head">
                                                        <h5 class="cart__info-name">Bàn Phím Cơ Gaming K1000 CAO CẤP FULL LED RGB | Hợp Kim Nhôm Cao Cấp Có Kê Tay, Blue Switch Gõ Cực Đã</h5>
