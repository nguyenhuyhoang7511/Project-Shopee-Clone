                                ...
                                <div class="has-cart"> 
                                    ...
                                    <ul class="cart__list-products">                     
                                        <li class="cart___list-item">
                                            <img src="../assets/image/l-sp-6-1.jpg" alt="" class="cart__item-img-product">

                                            <div class="cart__item-info">
                                                <div class="cart__info-head">
                                                        <h5 class="cart__info-name">Balo nữ đi học thời trang cao cấp chất liệu vải dù chống nước tốt</h5>
