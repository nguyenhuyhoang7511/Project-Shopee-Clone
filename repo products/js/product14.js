                                ...
                                <div class="has-cart"> 
                                    ...
                                    <ul class="cart__list-products">                     
                                        <li class="cart___list-item">
                                            <img src="../assets/image/l-sp-14-1.jpg" alt="" class="cart__item-img-product">

                                            <div class="cart__item-info">
                                                <div class="cart__info-head">
                                                        <h5 class="cart__info-name">Quần tây baggy đi học nữ cạp có đai lưng cao màu đen dáng dài - Quần vải công sở Vitex dày dặn phối áo sơ mi đi học làm</h5>
