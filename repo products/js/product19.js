                                ...
                                <div class="has-cart"> 
                                    ...
                                    <ul class="cart__list-products">                     
                                        <li class="cart___list-item">
                                            <img src="../assets/image/l-sp-19-1.png" alt="" class="cart__item-img-product">

                                            <div class="cart__item-info">
                                                <div class="cart__info-head">
                                                        <h5 class="cart__info-name">Pista GP RR Ece Dot Top Soleluna</h5>
                                                        <!-- price: giá, multiply: dấu nhân, quantity: số lượng, classify: phân loại -->
                                                    <div class="cart__info-price">
                                                    <span class="cart__price-main">${newPrice < 1000 ? newPrice : newPrice >= 10000000 ? String(newPrice).slice(0, 2) + '.'.concat(String(newPrice).slice(2, 5))+ '.'.concat(String(newPrice).slice(5)) : newPrice >= 1000000 ? String(newPrice).slice(0, 1) + '.'.concat(String(newPrice).slice(1, 4))+ '.'.concat(String(newPrice).slice(4)) : newPrice >= 100000 ? String(newPrice).slice(0, 3) + '.'.concat(String(newPrice).slice(3)) :  newPrice >= 10000 ? String(newPrice).slice(0, 2) + '.'.concat(String(newPrice).slice(2)) : String(newPrice).slice(0, 1) + '.'.concat(String(newPrice).slice(1))}.000đ</span>
